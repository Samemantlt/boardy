...
public static partial class NewRound
{
    public record Request(Guid RoomId, Guid PlayerId) : IRequest, IAdminRequest;
...
public static partial class ShowSecret
{
    public record Request(Guid RoomId, Guid PlayerId) : IRequest, IAdminRequest;
    ...
    public class Handler : IRequestHandler<Request>
    {
        ...
        public async Task Handle(Request request, CancellationToken cancellationToken)
        {
            ...
            room.Invoke(room.GameStateMachine.ShowSecret);
...
public static partial class StartVoting
{
    public record Request(Guid RoomId, Guid PlayerId) : IRequest, IAdminRequest;
    ...
    public class Handler : IRequestHandler<Request>
    {
        ...
        public async Task Handle(Request request, CancellationToken cancellationToken)
        {
            ...
            room.Invoke(room.GameStateMachine.StartVoting);
...
public static partial class EndVoting
{
    public record Request(Guid RoomId, Guid PlayerId) : IRequest, IAdminRequest;
    ...
    public class Handler : IRequestHandler<Request>
    {
        ...
        public async Task Handle(Request request, CancellationToken cancellationToken)
        {
            ...
            room.Invoke(room.GameStateMachine.EndVoting);
...
public static partial class EndGame
{
    public record Request(Guid RoomId, Guid PlayerId) : IRequest, IAdminRequest;
